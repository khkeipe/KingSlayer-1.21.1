...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature>  CRATE_PLACED_KEY = registerKey("crate_placed");

    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        var configuredFeatures = context.lookup(Registries.CONFIGURED_FEATURE);

        register(context,CRATE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.CRATE_KEY),
